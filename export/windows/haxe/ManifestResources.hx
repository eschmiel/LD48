...
@:keep @:noCompletion #if display private #end class __ASSET__assets_data_8x8castpixel_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/8x8CastPixel.ttf"; name = "8x8BoldWideMono"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__assets_data_stylish6x5_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/stylish6x5.ttf"; name = "stylish6x5"; super (); }}


#else

@:keep @:expose('__ASSET__assets_data_8x8castpixel_ttf') @:noCompletion #if display private #end class __ASSET__assets_data_8x8castpixel_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/data/8x8CastPixel.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "8x8BoldWideMono"; super (); }}
@:keep @:expose('__ASSET__assets_data_stylish6x5_ttf') @:noCompletion #if display private #end class __ASSET__assets_data_stylish6x5_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/data/stylish6x5.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "stylish6x5"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_data_8x8castpixel_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_8x8castpixel_ttf extends openfl.text.Font { public function new () { name = "8x8BoldWideMono"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_data_stylish6x5_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_stylish6x5_ttf extends openfl.text.Font { public function new () { name = "stylish6x5"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__assets_data_8x8castpixel_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_8x8castpixel_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/8x8CastPixel.ttf"; name = "8x8BoldWideMono"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_data_stylish6x5_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_stylish6x5_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/stylish6x5.ttf"; name = "stylish6x5"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
