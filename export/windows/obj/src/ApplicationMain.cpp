...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("LD48",fc,fd,6f,32),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("529",3c,63,28,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("LD48",fc,fd,6f,32));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("LD48",fc,fd,6f,32));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("LD48",fc,fd,6f,32))
