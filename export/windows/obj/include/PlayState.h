...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("PlayState",5d,83,c2,46); }
		 ...
		 ::flixel::group::FlxTypedGroup soil;
		 ::flixel::group::FlxTypedGroup deco;
		 ::flixel::tile::FlxTilemap fence;
		...
		void setTarget( ::Dynamic playerTargetObject, ::flixel::FlxObject target);
		::Dynamic setTarget_dyn();

		void updatePlayerTarget();
		::Dynamic updatePlayerTarget_dyn();

		void updateCursor();
		::Dynamic updateCursor_dyn();

		void setupSoil( ::Dynamic entity);
		::Dynamic setupSoil_dyn();

		void placeDeco( ::Dynamic entity);
		::Dynamic placeDeco_dyn();

		void setupMap();
		::Dynamic setupMap_dyn();

		void setupEntities();
		::Dynamic setupEntities_dyn();
